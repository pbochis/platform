...
public interface ChallengeRepository extends JpaRepository<Challenge, Long>{
    ...
    @Query("SELECT challenge FROM Challenge challenge " +
            ...
            "WHERE challengeTemplate.id=:challengeTemplate AND challenge.startDate=:startDate")
    Challenge findOneByTemplateAndStartDateWithOrganization(@Param("challenge") Long challengeTemplate, @Param("startDate")ZonedDateTime startDate);
